...
class TipCalculator():
    def __init__(self):
        ...
        calculate_btn = Button(window,text='Calculate',bg='green',fg='green',command=self.calculate)
        calculate_btn.grid(column=1,row=7,padx=15)

        clear_btn = Button(window,text='Clear',bg='black',fg='black',command=self.clear)
